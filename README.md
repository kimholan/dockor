...
socat to forward HTTP-traffic to the docker daemon and conquer the world!
```
/usr/bin/socat ${SOCAT_OPTIONS:-TCP-LISTEN:6666,reuseaddr,fork,forever,backlog=256 UNIX-CLIENT:/var/run/docker.sock}
```
...
You can then execute your native executable with: `./target/dockor-1.0.0-SNAPSHOT-runner`
